...
function togglebtn(){
	...
	if(document.getElementById("btnMve").name == "Move Shape")
	{ 	
	
		canvas.removeEventListener("mousedown", mouseDown, false);
		document.getElementById("btnMve").name = "Draw Shape";	
		document.getElementById("toggle").innerHTML="Move";	
		document.getElementById("spid").innerHTML="Click here to move the circles";
		canvas.addEventListener('mousedown', dragStart, false);
		canvas.addEventListener('mousemove', drag, false);
		canvas.addEventListener('mouseup', dragStop, false);				
	}
	else if(document.getElementById("btnMve").name == "Draw Shape")
	{         
		...
		document.getElementById("toggle").innerHTML="Draw";
